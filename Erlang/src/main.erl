...
start() -> 
    ...
    [Map, S_amount, S_times, S_nr_of_infected, S_range, S_probability, S_life, S_mode] = Args,
...
%% When the end condition is reached the simulation will stop. 
%% 
...
%% @param Mode the switch for the end conditions
%%
