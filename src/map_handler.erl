...
%%
%% @doc Sends the name of a Map to the Java server and then waits to receive information about the Map. 
...
get_map(Java_connection, Map) ->
	...
	Java_connection ! {self(), 'map_please', Map},
